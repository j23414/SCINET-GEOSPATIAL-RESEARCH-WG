...
1. Login to your SCINet/Ceres account through the JupyterHub web interface
   ...
   * Submit the Spawning Page with the following information (if not specified below, leave blank):<br>
   ...
   {% capture text %}
   These next two fields are important to enter correctly on the Spawning Page or you will not be able to run the tutorials once you are logged in:
...
2. Copy the tutorial jupyter notebook file into your home directory
